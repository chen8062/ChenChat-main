...
import com.chen.common.chat.domain.entity.RoomFriend;
...
import com.chen.common.common.domain.vo.request.PageBaseReq;
import com.chen.common.common.domain.vo.response.CursorPageBaseResp;
import com.chen.common.common.domain.vo.response.PageBaseResp;
...
import com.chen.common.user.dao.UserFriendDao;
import com.chen.common.user.domain.entity.User;
import com.chen.common.user.domain.entity.UserApply;
import com.chen.common.user.domain.entity.UserFriend;
import com.chen.common.user.domain.vo.request.friend.FriendApplyReq;
import com.chen.common.user.domain.vo.request.friend.FriendApproveReq;
import com.chen.common.user.domain.vo.request.friend.FriendCheckReq;
import com.chen.common.user.domain.vo.response.friend.FriendApplyResp;
import com.chen.common.user.domain.vo.response.friend.FriendCheckResp;
import com.chen.common.user.domain.vo.response.friend.FriendResp;
import com.chen.common.user.domain.vo.response.friend.FriendUnreadResp;
import com.chen.common.user.service.FriendService;
import com.chen.common.user.service.adapter.FriendAdapter;
...
import static com.chen.common.user.domain.enums.ApplyStatusEnum.WAIT_APPROVAL;
