...
import com.chen.common.user.domain.enums.WSRespTypeEnum;
...
import static com.chen.common.user.domain.vo.response.ws.WSMemberChange.CHANGE_TYPE_ADD;
import static com.chen.common.user.domain.vo.response.ws.WSMemberChange.CHANGE_TYPE_REMOVE;
