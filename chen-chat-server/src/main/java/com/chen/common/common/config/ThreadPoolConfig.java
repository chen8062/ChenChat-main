package com.chen.common.common.config;

import com.chen.common.common.factory.MyThreadFactory;
...
public class ThreadPoolConfig implements AsyncConfigurer, SecureInvokeConfigurer {
     ...
     * 项目共用线程池
     */
    public static final String CHEN_EXECUTOR = "chenExecutor";
    /**
     * websocket通信线程池
     */
    ...
    @Bean(CHEN_EXECUTOR)
    @Primary
    public ThreadPoolTaskExecutor chenExecutor() {
        ThreadPoolTaskExecutor executor = new ThreadPoolTaskExecutor();
        executor.setCorePoolSize(10);
        executor.setMaxPoolSize(10);
        executor.setQueueCapacity(200);
        executor.setThreadNamePrefix("chen-executor-");
