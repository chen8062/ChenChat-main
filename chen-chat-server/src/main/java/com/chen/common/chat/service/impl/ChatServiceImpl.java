package com.chen.common.chat.service.impl;
...
import com.chen.common.chat.dao.*;
import com.chen.common.chat.domain.dto.MsgReadInfoDTO;
import com.chen.common.chat.domain.entity.*;
import com.chen.common.chat.domain.enums.MessageMarkActTypeEnum;
import com.chen.common.chat.domain.enums.MessageTypeEnum;
...
import com.chen.common.chat.domain.vo.response.ChatMemberStatisticResp;
import com.chen.common.chat.domain.vo.response.ChatMessageReadResp;
import com.chen.common.chat.domain.vo.response.ChatMessageResp;
import com.chen.common.chat.service.ChatService;
import com.chen.common.chat.service.ContactService;
import com.chen.common.chat.service.adapter.MemberAdapter;
import com.chen.common.chat.service.adapter.MessageAdapter;
import com.chen.common.chat.service.adapter.RoomAdapter;
import com.chen.common.chat.service.cache.RoomCache;
import com.chen.common.chat.service.cache.RoomGroupCache;
import com.chen.common.chat.service.helper.ChatMemberHelper;
import com.chen.common.chat.service.strategy.mark.AbstractMsgMarkStrategy;
import com.chen.common.chat.service.strategy.mark.MsgMarkFactory;
import com.chen.common.chat.service.strategy.msg.AbstractMsgHandler;
import com.chen.common.chat.service.strategy.msg.MsgHandlerFactory;
import com.chen.common.chat.service.strategy.msg.RecallMsgHandler;
import com.chen.common.common.annotation.RedissonLock;
import com.chen.common.common.domain.enums.NormalOrNoEnum;
...
import com.chen.common.common.event.MessageSendEvent;
import com.chen.common.common.utils.AssertUtil;
import com.chen.common.user.dao.UserDao;
import com.chen.common.user.domain.entity.User;
import com.chen.common.user.domain.enums.ChatActiveStatusEnum;
