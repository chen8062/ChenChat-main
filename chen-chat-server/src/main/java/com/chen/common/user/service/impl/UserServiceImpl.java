...
import com.chen.common.common.event.UserBlackEvent;
import com.chen.common.common.event.UserRegisterEvent;
import com.chen.common.common.utils.AssertUtil;
import com.chen.common.common.algorithm.sensitiveWord.SensitiveWordBs;
import com.chen.common.user.dao.BlackDao;
import com.chen.common.user.dao.ItemConfigDao;
import com.chen.common.user.dao.UserBackpackDao;
import com.chen.common.user.dao.UserDao;
import com.chen.common.user.domain.dto.ItemInfoDTO;
import com.chen.common.user.domain.dto.SummeryInfoDTO;
...
import com.chen.common.user.domain.entity.UserBackpack;
import com.chen.common.user.domain.enums.BlackTypeEnum;
import com.chen.common.user.domain.enums.ItemEnum;
import com.chen.common.user.domain.enums.ItemTypeEnum;
import com.chen.common.user.domain.vo.request.user.*;
import com.chen.common.user.domain.vo.response.user.BadgeResp;
import com.chen.common.user.domain.vo.response.user.UserInfoResp;
import com.chen.common.user.service.UserService;
import com.chen.common.user.service.adapter.UserAdapter;
import com.chen.common.user.service.cache.ItemCache;
import com.chen.common.user.service.cache.UserCache;
import com.chen.common.user.service.cache.UserSummaryCache;
